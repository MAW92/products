...
function renderFilters(filters) {
  ...
  filters.forEach((filter) => {
    ...
    filterContainer.classList.add('inline-block','items-center','text-sm','gap-3','space-3','mx-auto');
