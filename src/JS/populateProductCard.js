...
function createProductCard(product) {
  ...
  card.innerHTML=`
    <a href="${product.viewItemURL}" style="none" target="_blank" title="View on eBay" class="card mt-2 hover:text-shadow text-white">
...
function displayProductCards(products) {
  // Get the product grid and card list elements
  ...
  // Generate product cards and append to the grid and list
